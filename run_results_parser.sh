...
if [ $exp = "Base_experiment" ]; then
  ...
  # MN
  filename="simulation_results_q100_sel100_popmakeup-MN_tpformation-window_collective.RData"
  files=$(find $parsedir -maxdepth 1 -name "simulation_results*sel100_popmakeup-MN_*tpformation-window*")
  
  Rscript Code/simulation_parse_results.R $(echo $filename $files)
  
  # ND
  filename="simulation_results_q100_sel100_popmakeup-ND_tpformation-window_collective.RData"
  files=$(find $parsedir -maxdepth 1 -name "simulation_results*sel100_popmakeup-ND_*tpformation-window*")
  
  Rscript Code/simulation_parse_results.R $(echo $filename $files)
  
  # MNxND and random
  filename="simulation_results_q100_sel100_popmakeup-MNxND_tpformation-window_collective.RData"
  ...
  # MN cumulative
  filename="simulation_results_q100_sel100_popmakeup-MN_tpformation-cumulative_collective.RData"
  files=$(find $parsedir -maxdepth 1 -name "simulation_results*sel100_popmakeup-MN_*tpformation-cumulative*")
  
  Rscript Code/simulation_parse_results.R $(echo $filename $files)
  
  # ND cumulative
  filename="simulation_results_q100_sel100_popmakeup-ND_tpformation-cumulative_collective.RData"
  files=$(find $parsedir -maxdepth 1 -name "simulation_results*sel100_popmakeup-ND_*tpformation-cumulative*")
